...
- スライド枚数は動画全体で目安16〜22枚程度にする（概要パートの4〜6枚に加えて、
  残り約9分の詳細解説パートにも1シーンあたり最低1枚を割り当てるとこの枚数感になる。
  概要パートを密にした分、全体の枚数目安も従来（10〜16枚）より増やしている）
...
- スライド枚数が多すぎ/少なすぎないか（目安16〜22枚程度。概要パートの4〜6枚を
  含めた全体の枚数感なので、以前の10〜16枚という基準では判断しないこと）
